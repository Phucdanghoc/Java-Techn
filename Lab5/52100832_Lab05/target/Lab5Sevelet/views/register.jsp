        ...
        <form method="post" action="register" >
          <div class="form-group">
            ...
            <div class="input-group mb-3">
              ...
              <input id="name" type="text" class="form-control" placeholder="Your Name" name="username">
            </div>
            ...
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <input id="password-confirm" type="password" class="form-control" placeholder="Password" name="password-confirm">
              </div>
            </div>
            <div class="form-group">
